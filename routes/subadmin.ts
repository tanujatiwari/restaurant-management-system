...
router.post('/add/restaurants', authenticateSubadmin, validations.validateAddRestaurant, subadmin.addRestaurant)

router.post('/restaurants/:restId/dishes', authenticateSubadmin, validations.validateAddDish, subadmin.addDish)
